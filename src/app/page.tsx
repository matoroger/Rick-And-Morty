...
<div className="filter-wrapper">
  <div className="filter-card">
    ...
    <div className="relative">
      ...
      <svg className="filter-icon-left" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
    ...
    <div className="relative">
      ...
      <svg className="filter-icon-right" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
